...
for pd in [1,2,3,4]:
    file = open(f'./logs/hw2_problem2_interpolation_out_{pd}.log', 'w')
    sys.stdout = file
...
plt.show()
fig.savefig('./logs/hw2_problem2_interpolation_u.png', dpi=300, bbox_inches="tight")
...
plt.show()
fig.tight_layout()
fig.savefig(f'./logs/hw2_problem2_interpolation.png', dpi=300)
