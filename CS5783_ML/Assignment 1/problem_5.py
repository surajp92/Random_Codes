...
for i in range(nsamples):
    ...
    mean = np.random.randn(1,2).flatten()
...
plot_results(train_c0, train_c1, test_c0, test_c1, test_ic0, test_ic1,'linear_classifier_5.pdf')
...
plot_results(train_c0_kdt, train_c1_kdt, test_c0_kdt, test_c1_kdt, test_ic0_kdt, test_ic1_kdt,'kdtree_classifier_5.pdf')
