...
# x = LSTM(64, return_sequences=True,activation=tf.keras.layers.LeakyReLU(alpha=0.1), kernel_initializer='glorot_normal')(a) # main1 
...
# x = LSTM(128, return_sequences=True,activation='relu', kernel_initializer='glorot_normal')(b) # main2
# # b = LSTM(64, return_sequences=True,activation='relu', kernel_initializer='glorot_normal')(b) # skip2

# x = LSTM(64, return_sequences=True,activation=lrelu, kernel_initializer='glorot_normal')(x) # main2
...
#%%
model = lstm_model(n_layers=4,n_cells=120,act_func=1,initializer=3,optimizer=3,type_lstm=1)
model.summary()
history = model.fit(xtrain, ytrain, epochs=5, batch_size=128, validation_data= (xvalid,yvalid))
