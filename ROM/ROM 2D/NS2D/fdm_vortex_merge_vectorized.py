...
filename = "./snapshots/Re_500/w/w_0.csv"
np.savetxt(filename, w, delimiter=",")
filename = "./snapshots/Re_500/s/s_0.csv"
...
for k in range(1,nt+1):
    ...
    if (k%freq == 0):
        filename = "./snapshots/Re_500/w/w_"+str(int(k/freq))+".csv"
        np.savetxt(filename, w, delimiter=",")
        filename = "./snapshots/Re_500/s/s_"+str(int(k/freq))+".csv"
        np.savetxt(filename, s, delimiter=",")
...
fig.savefig("./snapshots/Re_500/field_fdm.eps", bbox_inches = 'tight')
