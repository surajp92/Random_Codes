...
#        t1 = np.linspace(0,dt,2)
    ...
    for k in range(3):
        e = ee[:,k]
        et = odeint(df, e, t1, args=(x0[0], x0[1], x0[2]))
        ee[:,k] = et[-1]
...
#%%
print(f'LCE1 = {round(LCE1,4)} {round(LCE[0],4)}')
print(f'LCE2 = {round(LCE2,4)} {round(LCE[1],4)}')
print(f'LCE3 = {round(LCE3,4)} {round(LCE[2],4)}')
