...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 26 18:44:56 2019
...
if __name__ == '__main__':
    ...
    plt.subplot('221')
    plt.hist(np.array(Y),bins=int(sqrt(N)//2),orientation='horizontal',normed=True)

    plt.subplot('224')
    plt.hist(X,bins=int(sqrt(N)//2),normed=True)
